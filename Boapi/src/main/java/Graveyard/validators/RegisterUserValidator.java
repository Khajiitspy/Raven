package Graveyard.validators;

import lombok.RequiredArgsConstructor;
import Graveyard.data.dto.account.UserRegisterDTO;
import Graveyard.data.dto.validation.FieldError;
import Graveyard.interfaces.ValidationRule;
import Graveyard.interfaces.Validator;
...
public class RegisterUserValidator implements Validator<UserRegisterDTO> {
    ...
    public List<FieldError> validate(UserRegisterDTO dto) {
        ...
        List<ValidationRule<UserRegisterDTO>> rules = List.of(
        ...
        for (ValidationRule<UserRegisterDTO> rule : rules) {
